...
public class CategoryBusinessTypeCatalogResponse {
    ...
    public static CategoryBusinessTypeCatalogResponse from(CategoryBusinessTypeCatalogEntity e) {
        return CategoryBusinessTypeCatalogResponse.builder()
            .id(e.getId())
            .name(e.getName())
            .nameKh(e.getNameKh())
